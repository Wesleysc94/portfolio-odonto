...
export default function Solutions() {
    ...
    return (
        <section className="py-24 md:py-32 relative w-full z-10 overflow-visible">
            ...
            <div className="absolute inset-0 w-full h-full bg-[linear-gradient(to_right,#80808015_1px,transparent_1px),linear-gradient(to_bottom,#80808015_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_85%,transparent_100%)] animate-gridFlow pointer-events-none" />

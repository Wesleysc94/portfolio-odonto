...
export default function FooterCTA() {
    return (
        <footer className="relative mt-20 py-32 px-6 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[80vw] h-[80vw] max-w-[600px] max-h-[600px] bg-zinc-600/5 dark:bg-zinc-500/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            >
                <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif text-slate-800 dark:text-white mb-6 md:mb-8 leading-tight text-balance">
                    Vamos transformar sua <span className="italic text-slate-500 dark:text-zinc-400 block mt-2">presença digital.</span>
                </h2>

                <p className="text-slate-600 dark:text-zinc-400 font-sans text-base sm:text-lg md:text-xl mb-10 md:mb-14 font-light max-w-2xl text-balance">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 w-full sm:w-auto">
                    ...
                    <a
                        href="https://wa.me/5511999999999" target="_blank" rel="noreferrer"
                        className="group flex gap-2 sm:gap-3 items-center justify-center px-6 sm:px-8 py-4 border border-slate-300 dark:border-zinc-800 bg-transparent text-slate-700 dark:text-zinc-300 font-sans font-bold text-xs sm:text-sm tracking-widest uppercase rounded-full hover:bg-slate-100 dark:hover:bg-zinc-900 hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto whitespace-nowrap"
                    >

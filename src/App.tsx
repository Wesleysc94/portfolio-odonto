      ...
      <div className="fixed bottom-6 left-0 w-full px-6 z-50 flex justify-between items-end pointer-events-none">
        ...
        <div className="pointer-events-auto relative">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="relative group flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:-translate-y-2 hover:bg-[#1ebd59] transition-all duration-300 z-10"
          >
